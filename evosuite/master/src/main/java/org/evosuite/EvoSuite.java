...
public class EvoSuite {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            evosuite.parseCommandLine(Arrays.copyOfRange(args, 2, args.length), args[0], args[1]);
        } catch (Throwable t) {
...
//        logger.info("EvoSuite -> commons-email: " + ((end-start)/1000) + "s");
        /*
...
//             }
             ...
             return TestGeneration.executeTestGeneration(options, javaOpts, line, null, null);
     ...
     */
    public Object parseCommandLine(String[] args, String tDir, String rDir) {
        Options options = CommandLineParameters.getCommandLineOptions();
...
//            }
            ...
            return TestGeneration.executeTestGeneration(options, javaOpts, line, tDir, rDir);
